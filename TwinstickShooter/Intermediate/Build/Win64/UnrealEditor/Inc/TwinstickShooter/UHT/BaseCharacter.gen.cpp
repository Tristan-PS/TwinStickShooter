...
// End Cross Module References
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_ABaseCharacter_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_ABaseCharacter_CalculateHealth, "CalculateHealth" }, // 1596029528
	};
...
#endif
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UClass_ABaseCharacter_Statics::NewProp_Health = { "Health", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(ABaseCharacter, Health), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_ABaseCharacter_Statics::NewProp_Health_MetaData), Z_Construct_UClass_ABaseCharacter_Statics::NewProp_Health_MetaData) };
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_ABaseCharacter_Statics::NewProp_isDead_MetaData[] = {
		{ "Category", "Base Character" },
#if !UE_BUILD_SHIPPING
		{ "Comment", "//Make ab isDead property\n" },
#endif
		{ "ModuleRelativePath", "BaseCharacter.h" },
#if !UE_BUILD_SHIPPING
		{ "ToolTip", "Make ab isDead property" },
#endif
	};
#endif
	...
	struct Z_CompiledInDeferFile_FID_Users_TPS_Documents_GitHub_TwinStickShooter_TwinstickShooter_Source_TwinstickShooter_BaseCharacter_h_Statics
	{
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Users_TPS_Documents_GitHub_TwinStickShooter_TwinstickShooter_Source_TwinstickShooter_BaseCharacter_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_ABaseCharacter, ABaseCharacter::StaticClass, TEXT("ABaseCharacter"), &Z_Registration_Info_UClass_ABaseCharacter, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(ABaseCharacter), 2253946591U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Users_TPS_Documents_GitHub_TwinStickShooter_TwinstickShooter_Source_TwinstickShooter_BaseCharacter_h_2617687758(TEXT("/Script/TwinstickShooter"),
		Z_CompiledInDeferFile_FID_Users_TPS_Documents_GitHub_TwinStickShooter_TwinstickShooter_Source_TwinstickShooter_BaseCharacter_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Users_TPS_Documents_GitHub_TwinStickShooter_TwinstickShooter_Source_TwinstickShooter_BaseCharacter_h_Statics::ClassInfo),
		nullptr, 0,
		nullptr, 0);
